...
declare const postUpdateLikeEventDataSchema: yup.ObjectSchema<{
    brand: object & {
        id: any;
        tenantId: any;
        businessUnitId: any;
...
declare type PostUpdateLikeEventData = yup.InferType<typeof postUpdateLikeEventDataSchema> & {
    brand: Brand;
    case: Case;
    message: Message;
    channel: Channel;
};
export declare const postUpdateLikeEventSchema: yup.ObjectSchema<{
    data: object & {
        brand: any;
        case: any;
        message: any;
...
export declare type PostUpdateLikeEvent = yup.InferType<typeof postUpdateLikeEventSchema> & PushUpdateEventFields & {
    eventObject: PushUpdateEventObject.MESSAGE | PushUpdateEventObject.CASE;
    data: PostUpdateLikeEventData;
};
export {};
