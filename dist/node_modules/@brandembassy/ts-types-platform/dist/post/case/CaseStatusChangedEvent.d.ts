...
export declare type CaseStatusChangedData = yup.InferType<typeof caseStatusChangedEventDataSchema> & {
    brand: Brand;
    case: Case;
    channel: Channel;
};
export declare const caseStatusChangedEventSchema: yup.ObjectSchema<{
    data: object & {
        brand: any;
        case: any;
        channel: any;
...
export declare type CaseStatusChangedEvent = yup.InferType<typeof caseStatusChangedEventSchema> & PushUpdateEventFields & {
