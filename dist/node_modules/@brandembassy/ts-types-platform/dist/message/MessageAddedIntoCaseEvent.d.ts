...
declare const messageAddedIntoCaseDataSchema: yup.ObjectSchema<{
    brand: object & {
        id: any;
        tenantId: any;
        businessUnitId: any;
...
declare type MessageAddedIntoCaseData = yup.InferType<typeof messageAddedIntoCaseDataSchema> & {
    brand: Brand;
    message: Message;
    case: Case;
    channel: Channel;
};
export declare const messageAddedIntoCaseEventSchema: yup.ObjectSchema<{
    data: object & {
        brand: any;
        message: any;
        case: any;
...
export declare type MessageAddedIntoCaseEvent = yup.InferType<typeof messageAddedIntoCaseEventSchema> & PushUpdateEventFields & {
